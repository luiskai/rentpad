  ...
  const insertUser = () => {
    if (state.email === "" && state.password === "" && state.name === "") {
      ...
      if (ValidateEmail(state.email) == false) {
        alert("Has de introducir un email real.");
        return;
      } else {
        f.firebase
          .database()
          ...
          .once("value", (result) => {
            ...
            for (const res in resu) {
              if (resu[res].username === state.username) {
                alert(
                  "El nombre de usuario no esta disponible, prueba con otro."
                );
                return;
              }
            }
            f.firebase
              ...
              .then((res) => {
                ...
                f.firebase.auth().currentUser.updateProfile(usernameProfile);
              })
              .catch((err) => {
